...
This was an experiment I wanted to run to see if it really was possible to build a somewhat complicated usable application using Claude Code's Opus 4.5 Model.
...
<!-- TODO: Replace placeholder URLs with actual GitHub-hosted screenshot URLs.
     To get URLs: open a GitHub issue draft, drag-drop each image, copy the generated URL, then close without submitting. -->

<img width="1684" height="937" alt="Home Screen" src="https://github.com/user-attachments/assets/cb11f3e8-8134-40aa-973e-520f8a652bdb" />
